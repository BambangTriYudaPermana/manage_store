...
<div class="navbar navbar-inverse" role="navigation">
	<div class="navbar-header"><a class="navbar-brand" href="#"><img src="<?=base_url()?>asset/images/logo.png" alt="Londinium"></a><a class="sidebar-toggle"><i class="icon-paragraph-justify2"></i></a>
    ...
    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown"><i class="icon-paragraph-justify2"></i><span class="label label-default">6</span></a>
      <div class="popup dropdown-menu dropdown-menu-right">
        ...
        <ul class="popup-messages">
          <li class="unread"><a href="#"><img src="<?=base_url()?>asset/images/demo/users/face1.png" alt="" class="user-face"><strong><?=$username?> <i class="icon-attachment2"></i></strong><span>Aliquam interdum convallis massa...</span></a></li>
          <li><a href="#"><img src="<?=base_url()?>asset/images/demo/users/face2.png" alt="" class="user-face"><strong>Jason Goldsmith <i class="icon-attachment2"></i></strong><span>Aliquam interdum convallis massa...</span></a></li>
          <li><a href="#"><img src="<?=base_url()?>asset/images/demo/users/face3.png" alt="" class="user-face"><strong>Angel Novator</strong><span>Aliquam interdum convallis massa...</span></a></li>
          <li><a href="#"><img src="<?=base_url()?>asset/images/demo/users/face4.png" alt="" class="user-face"><strong>Monica Bloomberg</strong><span>Aliquam interdum convallis massa...</span></a></li>
          <li><a href="#"><img src="<?=base_url()?>asset/images/demo/users/face5.png" alt="" class="user-face"><strong>Patrick Winsleur</strong><span>Aliquam interdum convallis massa...</span></a></li>
        </ul>
      </div>
    </li>
	...
	-->
	<li class="user dropdown"><a class="dropdown-toggle" data-toggle="dropdown"><img src="<?=base_url()?>asset/images/foto/<?=$profile_foto?>" alt=""><span><?=$profile_name?></span><i class="caret"></i></a>
      <ul class="dropdown-menu dropdown-menu-right icons-right">
        <li><a href="<?=site_url('profile/detail')?>"><i class="icon-user"></i> Profile</a></li>
		<li><a href="<?=site_url('auth/change_password')?>"><i class="icon-lock"></i> Change Password</a></li>
		<!--
			<li><a href="#"><i class="icon-bubble4"></i> Messages</a></li>
			<li><a href="#"><i class="icon-cog"></i> Settings</a></li>
		-->
        <li><a href="<?=site_url('auth/logout')?>"><i class="icon-exit"></i> Logout</a></li>
      </ul>
    </li>
  </ul>
</div>
