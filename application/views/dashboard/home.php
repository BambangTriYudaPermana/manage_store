	...
	<div class="tab-pane active fade in" id="activity">
		...
		<div class="col-md-6">
		  ...
		  <div class="block">
			...
			<ul class="message-list">
			  ...
			  <li>
				<div class="clearfix">
				  <div class="chat-member"><a href="#"><img src="<?php echo base_url();?>asset/images/demo/users/face1.png" alt=""></a>
			  ...
			  <li>
				<div class="clearfix">
				  <div class="chat-member"><a href="#"><img src="<?php echo base_url();?>asset/images/demo/users/face2.png" alt=""></a>
			  ...
			  <li>
				<div class="clearfix">
				  <div class="chat-member"><a href="#"><img src="<?php echo base_url();?>asset/images/demo/users/face3.png" alt=""></a>
			  ...
			  <li>
				<div class="clearfix">
				  <div class="chat-member"><a href="#"><img src="<?php echo base_url();?>asset/images/demo/users/face5.png" alt=""></a>
			  ...
			  <li>
				<div class="clearfix">
				  <div class="chat-member"><a href="#"><img src="<?php echo base_url();?>asset/images/demo/users/face6.png" alt=""></a>
			  ...
			  <li>
				<div class="clearfix">
				  <div class="chat-member"><a href="#"><img src="<?php echo base_url();?>asset/images/demo/users/face10.png" alt=""></a>
			  ...
			  <li>
				<div class="clearfix">
				  <div class="chat-member"><a href="#"><img src="<?php echo base_url();?>asset/images/demo/users/face11.png" alt=""></a>
	  ...
	  <div class="row">
		<div class="col-lg-3 col-md-6 col-sm-6">
		  <div class="block">
			<div class="thumbnail"><a href="images/demo/users/face1.png" class="thumb-zoom lightbox" title="Eugene A. Kopyov"><img src="<?php echo base_url();?>asset/images/demo/users/face1.png" alt=""></a>
		...
		<div class="col-lg-3 col-md-6 col-sm-6">
		  <div class="block">
			<div class="thumbnail"><a href="images/demo/users/face4.png" class="thumb-zoom lightbox" title="Sophia R. McJamer"> <img src="<?php echo base_url();?>asset/images/demo/users/face4.png" alt=""> </a>
			  <div class="caption text-center">
		...
		<div class="col-lg-3 col-md-6 col-sm-6">
		  <div class="block">
			<div class="thumbnail"><a href="images/demo/users/face8.png" class="thumb-zoom lightbox" title="Noah Kennedy"> <img src="<?php echo base_url();?>asset/images/demo/users/face8.png" alt=""> </a>
			  <div class="caption text-center">
		...
		<div class="col-lg-3 col-md-6 col-sm-6">
		  <div class="block">
			<div class="thumbnail"><a href="images/demo/users/face10.png" class="thumb-zoom lightbox" title="Will DeBrandon"> <img src="<?php echo base_url();?>asset/images/demo/users/face10.png" alt=""> </a>
			  <div class="caption text-center">
	  ...
	  <div class="block">
		...
		<ul class="media-list">
		  <li class="media"><a class="pull-left" href="#"><img class="media-object" src="<?php echo base_url();?>asset/images/demo/users/face25.png" alt=""></a>
		  ...
		  <li class="media"><a class="pull-left" href="#"><img class="media-object" src="<?php echo base_url();?>asset/images/demo/users/face24.png" alt=""></a>
			<div class="media-body">
		  ...
		  <li class="media"><a class="pull-left" href="#"><img class="media-object" src="<?php echo base_url();?>asset/images/demo/users/face23.png" alt=""></a>
			<div class="media-body">
		  ...
		  <li class="media"><a class="pull-left" href="#"><img class="media-object" src="<?php echo base_url();?>asset/images/demo/users/face22.png" alt=""></a>
			<div class="media-body">
		  ...
		  <li class="media"><a class="pull-left" href="#"><img class="media-object" src="<?php echo base_url();?>asset/images/demo/users/face21.png" alt=""></a>
			<div class="media-body">
		  ...
		  <li class="media"><a class="pull-left" href="#"><img class="media-object" src="<?php echo base_url();?>asset/images/demo/users/face20.png" alt=""></a>
			<div class="media-body">
		  ...
		  <li class="media"><a class="pull-left" href="#"><img class="media-object" src="<?php echo base_url();?>asset/images/demo/users/face19.png" alt=""></a>
			<div class="media-body">
		...
		<ul class="message-list">
		  ...
		  <li>
			...
			<div class="panel-collapse collapse" id="eugene_kopyov">
			  <div class="chat">
				<div class="message"> <a class="message-img" href="#"><img src="<?php echo base_url();?>asset/images/demo/users/face1.png" alt=""></a>
				  <div class="message-body"><span class="typing"></span> </div>
				</div>
				<div class="message reversed"> <a class="message-img" href="#"><img src="<?php echo base_url();?>asset/images/demo/users/face2.png" alt=""></a>
		  ...
		  <li>
			...
			<div class="panel-collapse collapse" id="duncan_mcmart">
			  <div class="chat">
				<div class="message"> <a class="message-img" href="#"><img src="<?php echo base_url();?>asset/images/demo/users/face2.png" alt=""></a>
				  <div class="message-body"><span class="typing"></span> </div>
				</div>
				<div class="message reversed"> <a class="message-img" href="#"><img src="<?php echo base_url();?>asset/images/demo/users/face3.png" alt=""></a>
				  <div class="message-body"> Nunc volutpat commodo ullamcorper. Vivamus consequat sapien ac ante pharetra pellentesque. Sed molestie leo vitae erat sagittis, ac posuere nibh faucibus. In nec massa suscipit, sagittis ligula non, accumsan velit. Pellentesque habitant morbi tristique senectus et netus et malesuada fames. <span class="attribution">14:23pm, 4th Dec 2010</span> </div>
				</div>
				<div class="moment">10 Nov, 2013</div>
				<div class="message"> <a class="message-img" href="#"><img src="<?php echo base_url();?>asset/images/demo/users/face2.png" alt=""></a>
		  ...
		  <li>
			...
			<div class="panel-collapse collapse" id="angel_nowak">
			  <div class="chat">
				<div class="message"> <a class="message-img" href="#"><img src="<?php echo base_url();?>asset/images/demo/users/face5.png" alt=""></a>
				  <div class="message-body"><span class="typing"></span> </div>
				</div>
				<div class="message reversed"> <a class="message-img" href="#"><img src="<?php echo base_url();?>asset/images/demo/users/face2.png" alt=""></a>
				  <div class="message-body"> Nunc volutpat commodo ullamcorper. Vivamus consequat sapien ac ante pharetra pellentesque. Sed molestie leo vitae erat sagittis, ac posuere nibh faucibus. In nec massa suscipit, sagittis ligula non, accumsan velit. Pellentesque habitant morbi tristique senectus et netus et malesuada fames. <span class="attribution">14:23pm, 4th Dec 2010</span> </div>
		  ...
		  <li>
			...
			<div class="panel-collapse collapse in" id="vin_dins">
			  <div class="chat">
				<div class="message"> <a class="message-img" href="#"><img src="<?php echo base_url();?>asset/images/demo/users/face6.png" alt=""></a>
				  <div class="message-body"><span class="typing"></span> </div>
				</div>
				<div class="message reversed"> <a class="message-img" href="#"><img src="<?php echo base_url();?>asset/images/demo/users/face2.png" alt=""></a>
				  <div class="message-body"> Nunc volutpat commodo ullamcorper. Vivamus consequat sapien ac ante pharetra pellentesque. Sed molestie leo vitae erat sagittis, ac posuere nibh faucibus. In nec massa suscipit, sagittis ligula non, accumsan velit. Pellentesque habitant morbi tristique senectus et netus et malesuada fames. <span class="attribution">14:23pm, 4th Dec 2010</span> </div>
		  ...
		  <li>
			<div class="clearfix">
			  <div class="chat-member"><a href="#"><img src="<?php echo base_url();?>asset/images/demo/users/face7.png" alt=""></a>
			...
			<div class="panel-collapse collapse" id="john_doe">
			  <div class="chat">
				<div class="message"> <a class="message-img" href="#"><img src="<?php echo base_url();?>asset/images/demo/users/face7.png" alt=""></a>
				  <div class="message-body"><span class="typing"></span> </div>
				</div>
				<div class="message reversed"> <a class="message-img" href="#"><img src="<?php echo base_url();?>asset/images/demo/users/face2.png" alt=""></a>
				  <div class="message-body"> Nunc volutpat commodo ullamcorper. Vivamus consequat sapien ac ante pharetra pellentesque. Sed molestie leo vitae erat sagittis, ac posuere nibh faucibus. In nec massa suscipit, sagittis ligula non, accumsan velit. Pellentesque habitant morbi tristique senectus et netus et malesuada fames. <span class="attribution">14:23pm, 4th Dec 2010</span> </div>
		  ...
		  <li>
			<div class="clearfix">
			  <div class="chat-member"><a href="#"><img src="<?php echo base_url();?>asset/images/demo/users/face8.png" alt=""></a>
			...
			<div class="panel-collapse collapse" id="barbara_madison">
			  <div class="chat">
				<div class="message"> <a class="message-img" href="#"><img src="<?php echo base_url();?>asset/images/demo/users/face8.png" alt=""></a>
				  <div class="message-body"><span class="typing"></span> </div>
				</div>
				<div class="message reversed"> <a class="message-img" href="#"><img src="<?php echo base_url();?>asset/images/demo/users/face2.png" alt=""></a>
				  <div class="message-body"> Nunc volutpat commodo ullamcorper. Vivamus consequat sapien ac ante pharetra pellentesque. Sed molestie leo vitae erat sagittis, ac posuere nibh faucibus. In nec massa suscipit, sagittis ligula non, accumsan velit. Pellentesque habitant morbi tristique senectus et netus et malesuada fames. <span class="attribution">14:23pm, 4th Dec 2010</span> </div>
		  ...
		  <li>
			...
			<div class="panel-collapse collapse" id="robert_razinsky">
			  <div class="chat">
				<div class="message"> <a class="message-img" href="#"><img src="<?php echo base_url();?>asset/images/demo/users/face10.png" alt=""></a>
				  <div class="message-body"><span class="typing"></span> </div>
				</div>
				<div class="message reversed"> <a class="message-img" href="#"><img src="<?php echo base_url();?>asset/images/demo/users/face2.png" alt=""></a>
				  <div class="message-body"> Nunc volutpat commodo ullamcorper. Vivamus consequat sapien ac ante pharetra pellentesque. Sed molestie leo vitae erat sagittis, ac posuere nibh faucibus. In nec massa suscipit, sagittis ligula non, accumsan velit. Pellentesque habitant morbi tristique senectus et netus et malesuada fames. <span class="attribution">14:23pm, 4th Dec 2010</span> </div>
		  ...
		  <li>
			...
			<div class="panel-collapse collapse" id="malik_smitsons">
			  <div class="chat">
				<div class="message"> <a class="message-img" href="#"><img src="<?php echo base_url();?>asset/images/demo/users/face11.png" alt=""></a>
				  <div class="message-body"><span class="typing"></span> </div>
				</div>
				<div class="message reversed"> <a class="message-img" href="#"><img src="<?php echo base_url();?>asset/images/demo/users/face2.png" alt=""></a>
				  <div class="message-body"> Nunc volutpat commodo ullamcorper. Vivamus consequat sapien ac ante pharetra pellentesque. Sed molestie leo vitae erat sagittis, ac posuere nibh faucibus. In nec massa suscipit, sagittis ligula non, accumsan velit. Pellentesque habitant morbi tristique senectus et netus et malesuada fames. <span class="attribution">14:23pm, 4th Dec 2010</span> </div>
		  ...
		  <li>
			<div class="clearfix">
			  <div class="chat-member"><a href="#"><img src="<?php echo base_url();?>asset/images/demo/users/face16.png" alt=""></a>
			...
			<div class="panel-collapse collapse" id="barnaba_pall">
			  <div class="chat">
				<div class="message"> <a class="message-img" href="#"><img src="<?php echo base_url();?>asset/images/demo/users/face16.png" alt=""></a>
				  <div class="message-body"><span class="typing"></span> </div>
				</div>
				<div class="message reversed"> <a class="message-img" href="#"><img src="<?php echo base_url();?>asset/images/demo/users/face2.png" alt=""></a>
				  <div class="message-body"> Nunc volutpat commodo ullamcorper. Vivamus consequat sapien ac ante pharetra pellentesque. Sed molestie leo vitae erat sagittis, ac posuere nibh faucibus. In nec massa suscipit, sagittis ligula non, accumsan velit. Pellentesque habitant morbi tristique senectus et netus et malesuada fames. <span class="attribution">14:23pm, 4th Dec 2010</span> </div>
