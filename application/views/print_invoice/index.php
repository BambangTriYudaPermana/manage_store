                    ...
                    <div class="row align-items-end">
                        <div class="col-lg-8">
                            <div class="page-header-title">
                                <div class="d-inline">
                                    <h4>Print Invoice</h4>
                                    <span>Pilihlah nama pelanggan untuk melihat detail invoice </span>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="card">
                                ...
                                ?>
                                    <h3>Filter</h3>
                                        <form action="<?=base_url('print_invoice/');?>" method="post">
                                            <div class="row">
                                                <div class="col-md-6">
                                ...
                                <div class="card-block">
                                    <h4 class="sub-title">Print Invoice</h4>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td><?=$value->qty?> Pcs</td>
                                                <td><?=$value->ttl_berat?> Kg</td>
                                                <td style="text-align: right;"><?=number_format($value->total_harga)?></td>
                                                <td><?=$value->tgl_checkout?></td>
                                                <td>
                                                    <a href="<?=base_url('print_invoice/detail').'/'.$value->id_catatan?>" class="btn btn-primary btn-sm" title="Detail"><i class="fa fa-eye"></i>Detail</a>
                                                </td>
                                            </tr>
                                    <?php
                                    $no++;
