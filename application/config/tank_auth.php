...
|--------------------------------------------------------------------------
*/
$config['website_name'] = 'tintapuccino.com';
$config['webmaster_email'] = 'team@tintapuccino.com';
...
$config['registration_fields'][] = array('gender', 'Gender', 'trim|required|alpha|max_length[1]', 'radio', array('m'=>'Male', 'f'=>'Female'));
$config['registration_fields'][] = array('nip', 'NIP', 'trim|required', 'text');
$config['registration_fields'][] = array('tempat_lahir', 'Tempat Lahir', 'trim|required', 'text');
$config['registration_fields'][] = array('gol', 'Gol', 'trim|required', 'text');
$config['registration_fields'][] = array('eselon', 'Eselon', 'trim|required', 'text');
$config['registration_fields'][] = array('tmt_eselon', 'TMT Eselon', 'trim|required', 'date');
$config['registration_fields'][] = array('jabatan', 'Jabatan', 'trim|required', 'text');
$config['registration_fields'][] = array('grade', 'Grade', 'trim|required', 'text');
$config['registration_fields'][] = array('tempat_tugas', 'Tempat Tugas', 'trim|required', 'text');
$config['registration_fields'][] = array('agama', 'Agama', 'trim|required', 'dropdown', array('0'=>'- Pilih -', 'Islam'=>'Islam', 'Kristen'=>'Kristen'));
$config['registration_fields'][] = array('telepon', 'Telepon', 'trim|required', 'text');
$config['registration_fields'][] = array('unit_kerja', 'Unit Kerja', 'trim|required', 'text');
$config['registration_fields'][] = array('no_hp', 'No HP', 'trim|required', 'text');
$config['registration_fields'][] = array('npwp', 'NPWP', 'trim|required', 'text');
$config['registration_fields'][] = array('tmt_gol', 'TMT GOL', 'trim|required', 'date');
$config['registration_fields'][] = array('pd_jenjang', 'Jenjang Pendidikan Terakhir', 'trim|required', 'text');
$config['registration_fields'][] = array('pd_jurusan', 'Jenjang Pendidikan Jurusan', 'trim|required', 'text');
$config['registration_fields'][] = array('pd_sekolah', 'Jenjang Pendidikan Nama Sekolah', 'trim|required', 'text');
$config['registration_fields'][] = array('jenis_jabatan', 'Jenis Jabatan', 'trim|required', 'text');
$config['registration_fields'][] = array('tmt_cpns', 'TMT CPNS', 'trim|required', 'date');
$config['registration_fields'][] = array('tmt_pns', 'TMT PNS', 'trim|required', 'date');
$config['registration_fields'][] = array('tmt_jabatan', 'TMT Jabatan', 'trim|required', 'date');
$config['registration_fields'][] = array('masa_kerja_keseluruhan', 'Masa Kerja Keseluruhan', 'trim|required', 'text');
$config['registration_fields'][] = array('masa_kerja_jabatan', 'Masa Kerja Jabatan', 'trim|required', 'text');
$config['registration_fields'][] = array('masa_kerja_eselon', 'Masa Kerja Eselon', 'trim|required', 'text');
